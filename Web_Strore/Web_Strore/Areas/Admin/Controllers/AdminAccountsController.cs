...
namespace Web_Strore.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(STORE_WEBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var sTORE_WEBContext = _context.Accounts.Include(a => a.Role);
            return View(await sTORE_WEBContext.ToListAsync());
        }

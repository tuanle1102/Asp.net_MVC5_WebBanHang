...
{
    public partial class STORE_WEBContext : DbContext
    {
        public STORE_WEBContext()
        {
        }

        public STORE_WEBContext(DbContextOptions<STORE_WEBContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
              optionsBuilder.UseSqlServer("Server=localhost;Database=STORE_WEB;Trusted_connection=true;");
            }
        }
        ...
        public DbSet<Web_Strore.ModelViews.RegisterViewModel> RegisterViewModel { get; set; }
    }
}
